...
<body>
    ...
    <div id="form-container">
        ...
        <form action="coding_result.php" method="POST">
            <input type="text" id="topic" name="topic" placeholder="Enter the topic (Ex: JAVA)" required>
            <div class="input-container">
                <input type="number" id="number" placeholder="Number of Questions" name="number" required>
